...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Buddhi Dihansa — Aspiring AI Engineer" },
      { property: "og:description", content: "Data Science undergraduate building intelligent real-world systems with AI/ML." },
